...
<script>
    import InventoryCheckTaskDetails from "@/views/oa/task/inventorycheck/InventoryCheckTaskDetails";
    export default {
        name: "InventoryCheckTask",
        components: {InventoryCheckTaskDetails},
        mounted(){
            this.loadTask();
        },
        methods:{
            ...
            //加载任务列表
            loadTask(){
                this.getRequest('/flow/task/getInventoryCheckTask?page='+this.currentPage+'&size=10').then((resp)=>{
