                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item prop="initDate"  label="单据日期:">
                                <el-date-picker
                                        ...
                                        type="date"
                                        size="mini"
                                        v-model="productCompose.initDate"
                                        placeholder="选择日期"
                        ...
                        <el-col :span="8" >
                            <el-form-item label="单号录入方式:">
                                <el-select size="mini" v-model="productCompose.codeGeneratorType">
                                    <el-option key="AUTO" label="自动生成" value="AUTO"></el-option>
                                    <el-option key="SELF" label="手动录入" value="SELF"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8" v-show="productCompose.id||productCompose.codeGeneratorType=='SELF'">
                            <el-form-item label="单号:" prop="code" :required="productCompose.codeGeneratorType=='SELF'">
                                <el-input size="mini" v-model="productCompose.code" :disabled="isEdit"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8" >
                            <el-form-item label="组装仓库:">
                                <el-select size="mini" value-key="id" v-model="productCompose.warehouse">
                        ...
                        <el-col :span="10">
                            <el-form-item label="产品编号:">
                                <el-input
                                        ...
                                        size="mini"
                                        v-model="productCompose.product.code">
                                </el-input>
                        ...
                        <el-col :span="8">
                            <el-form-item label="产品名称:">
                                <el-input
                                        style="width: 300px; float: left"
                                        size="mini"
                                        v-model="productCompose.product.name">
                                </el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="备注:" prop="description">
                                <el-input type="textarea" v-model="productCompose.description"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            proDblclick(row) {
                this.productCompose.product = row;
