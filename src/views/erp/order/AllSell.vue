                ...
                <div style="margin-left: 5px;margin-right: 20px;display: inline">
                    <el-form @submit.native.prevent>
                        <el-input size="mini" placeholder="通过单号、产品编码、产品名称、客户名称搜索，记得回车呦..."
                                  ...
                                  @keyup.enter.native="loadSells"
                                  v-model="keywords"
                                  @change="keywordsChange"
                        ></el-input>
                        <el-button @click="loadSells" type="primary" size="mini" style="margin-left: 5px" icon="el-icon-search" :disabled="searchViewVisible">搜索</el-button>
                ...
                <transition name="slide-fade">
                    <div v-show="searchViewVisible" style="margin-bottom: 10px;border: 1px;border-radius: 5px;border-style: solid;padding: 5px 0px 5px 0px;box-sizing:border-box;border-color: #20a0ff">
                        ...
                        <el-row :gutter="20" style="margin-top: 20px">
                            ...
                            <el-button @click="loadSells" icon="el-icon-search" type="primary" size="mini" >搜索</el-button>
                        </el-row>
                    </div>
                </transition>
                <el-table @sort-change="sortChange" v-loading="loading" :data="sells" style="width:100%" @row-dblclick="dblclick">
...
<script>
        ...
        methods: {
            ...
            loadSells(){
                ...
                this.getRequest('/erp/sell/all?page='+
                    this.currentPage+
                    "&size="+this.pageSize+
                    "&sort="+this.sort+
                    "&order="+this.order+
