<template>
    <div>
        <el-form ref="customerForm" :model="customer" :rules="rules" label-width="120px" :label-position="labelPosition" style="margin-top: 10px;padding: 0px;">
            <el-card>
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="8">
                            <el-form-item label="拥有人:" prop="owner.realName" >
                                <el-input size="mini" class="input-with-select"  disabled v-model="customer.owner.realName"  style="float:left;width:400px;padding-top: 7px">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="16">
                            <el-form-item label="客户名称:" prop="name">
                                <el-input size="mini" v-model="customer.name"></el-input>
                            </el-form-item>

                        </el-col>
                        <el-col :span="16">
                            <el-form-item label="区域:" prop="area" >
                                <el-cascader clearable filterable :props="props" size="mini"  v-model="customer.area" style="float: left;width: 400px;padding-top:7px" placeholder="请选择国家/省/市/区">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="16">
                            <el-form-item label="详细地址:">
                                <el-input size="mini" v-model="customer.address"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20">
                        <el-form-item label="简介:">
                            <el-input type="textarea" size="mini" v-model="customer.description"></el-input>
                        </el-form-item>
                    </el-row>
                </div>
            </el-card>
            ...
            <el-card>
                ...
                <receiving-list :customerId="customer.id" :receivings="customer.receivings"></receiving-list>
            </el-card>
            <el-card>
                <el-button @click="saveCustomer('customerForm')" type="primary" size="mini" >保存</el-button>
...
<script>
    import LinkmanList from "@/views/erp/sell/LinkmanList";
    import ReceivingList from "@/views/erp/sell/ReceivingList";
    import UserDialog from "@/components/dialog/UserDialog";
    import {getRequest} from "@/utils/api";
    export default {
        name: "CustomerForm",
        components: {UserDialog, LinkmanList,ReceivingList},
        props:{
            oldCustomer:{
                type:Object,
                default:()=>{}
                ...
                this.$refs[formName].validate((valid)=>{
                    if(valid){
                        if(this.isEdit){
                            ...
                            this.postNoEnCodeRequest('/crm/customer/addCustomer',this.customer).then((resp)=>{
                                if(resp.data.status=="200"){
